...
public class ProcessedAdapter extends RecyclerView.Adapter<ProcessedAdapter.ViewHolder> {
    ...
    private ProcessedAdapter.OnClickListner mListner;

    @NonNull
    @Override
    public ProcessedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.orderstate_list_item, parent, false);
        return new ProcessedAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProcessedAdapter.ViewHolder holder, int position) {
    ...
    public void OnItemClickListner(ProcessedAdapter.OnClickListner listner) {
